...
using SpellWork.WinForms.Spell;
    ...
    public sealed partial class FormMain : Form
    {
        ...
        private void LvSpellListSelectedIndexChanged(object sender, EventArgs e)
        {
            if (_lvSpellList.SelectedIndices.Count > 0)
                _spellList[_lvSpellList.SelectedIndices[0]].Write(new RichTextBoxWrapper(_rtSpellInfo));
        }
        ...
        {
            spell.Write(new RichTextBoxWrapper(_rtbProcSpellInfo));
        }
        ...
        private void CompareFilterSpellTextChanged(object sender, EventArgs e)
        {
            ...
            if (DBC.DBC.SpellInfoStore.ContainsKey(spell1) && DBC.DBC.SpellInfoStore.ContainsKey(spell2))
                SpellCompare.Compare(new RichTextBoxWrapper(_rtbCompareSpell1), new RichTextBoxWrapper(_rtbCompareSpell2), DBC.DBC.SpellInfoStore[spell1], DBC.DBC.SpellInfoStore[spell2]);
        }
