...
public class VerticalPanel : Panel
{
    ...
    {
        AffectsMeasure<VerticalPanel>(BoundsProperty);
        AffectsArrange<VerticalPanel>(BoundsProperty);
    }
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        availableSize = availableSize.WithHeight(Math.Max(700, this.Bounds.Height));
